...
import { getAllProductIds, getProductById } from "@/src/features/products/api";
  ...
  return (
    <div className="mx-auto w-full max-w-[1280px] px-4 py-[50px]">
      ...
      <div className="grid gap-12 md:grid-cols-2">
        {/* 이미지 */}
        <div className="flex aspect-25/32 w-full items-center justify-center overflow-hidden rounded-[6px] border border-[#E9EAEC] bg-white">
